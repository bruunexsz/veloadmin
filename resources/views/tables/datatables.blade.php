...
@endpush
@section('content')
<div class="va-page-header"><div><h1 class="va-page-title">DataTables</h1><ul class="va-breadcrumb mt-1"><li><a href="{{ url('/') }}">Home</a></li><li>Tables</li><li>DataTables</li></ul></div></div>
<div class="va-card">
    <div class="va-card-header"><h5 class="va-card-title">Advanced DataTable</h5></div>
    <div class="va-card-body">
        <table id="dataTable" class="table table-striped va-table" style="width:100%">
            ...
            <tbody>
                ...
                <tr><td>Ashton Cox</td><td>Junior Developer</td><td>San Francisco</td><td>66</td><td>2009/01/12</td><td>$86,000</td></tr>
                <tr><td>Cedric Kelly</td><td>Senior Developer</td><td>Edinburgh</td><td>22</td><td>2012/03/29</td><td>$433,060</td></tr>
